...
const Career: FC = () => {
  ...
  return (
    <div
      className={`flex justify-between items-center mx-auto max-w-[100rem] py-10 gap-20 ${(phone === "phone" || phone === "tablet") && "flex-col justify-start"
        }`}
    >
      <Fade left>
      ...
      <Fade right>
        ...
        <div className=" flex flex-col gap-10">
          <div
            className={`${font ? "text-6xl" : "text-4xl"
          ...
          <div className={``}>
            <div
              className={`flex flex-col p-2 max-w-[20rem] gap-2 ${mode ? "bg-white text-black" : "bg-[#000000bd] text-white"
                }`}
            >
